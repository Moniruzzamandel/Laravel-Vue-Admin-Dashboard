          ...
          <div class="col-12">
            <div class="card" v-if="$gate.isAdminOrAuthor()">
              <div class="card-header">
                ...
                <div class="card-tools">
                    <button @click="addModal" class="btn btn-outline-success btn-md">ADD USER</button>
                </div>
              </div>
              <!-- /.card-header -->
                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr v-for="user in users.data" :key="user.id">
                      ...
                      <td>
                          <a href="#" @click="editModal(user)" class="btn btn-outline-info btn-sm">Edit</a>
                          <a href="#" @click="deleteUser(user.id)" class="btn btn-outline-danger btn-sm">Delete</a>
                      </td>
                    </tr>
            ...
            <div v-if="!$gate.isAdminOrAuthor()">
                <div class="card border-danger">
                    <div class="card-header border-danger">Page You are looking for is not found!</div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 class="modal-title" v-show="editMode" id="addUserModalLabel">UPDATE USER INFO</h5>
                ...
                <form @submit.prevent="editMode ? updateUser() : createUser()">
                    ...
                    <textarea v-model="form.bio" name="bio" id="bio" class="form-control" :class="{ 'is-invalid': form.errors.has('bio') }"></textarea>
                        ...
                        <div class="form-group">
                            <input v-model="form.password" type="text" name="password" placeholder="Enter Your Password"
